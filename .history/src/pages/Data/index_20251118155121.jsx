        ...
        <div className="max-w-7xl mx-auto px-6 text-white">
          ...
          <div className="p-8 mt-12 bg-white/5 border border-white/10 backdrop-blur rounded-2xl">
            ...
            <div className="flex gap-4 mt-6">
              ...
              <button className="px-5 py-2 rounded-xl border border-              <button className="px-5 py-2 rounded-xl border border-emerald-400 text-emerald-300 hover:bg-emerald-400/10 transition">
 text-emerald-300 hover:bg-emerald-400/10 transition">
                Get API Key
              </button>
            </div>
          </div>
