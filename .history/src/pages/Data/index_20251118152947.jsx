      ...
      <div className="min-h-screen w-full bg-[#0b0f19] pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-6 text-white">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-10">
            ...
            <div class="rounded-lg border bg-card text-card-foreground shadow-sm glass mb-8"><div class="p-6"><div class="relative"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-muted-foreground"><circle cx="11" cy="11" r="8"></circle><path d="m21 21-4.3-4.3"></path></svg><input class="flex h-10 w-full rounded-md border border-input px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm pl-10 bg-background/50" placeholder="Search datasets by name, category, or keywords..." value=""></div></div></div>
          </div>
