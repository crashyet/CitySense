      ...
      <div className="min-h-screen w-full bg-[#0b0f19] pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-6 text-white">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-10">
            ...
            <div class="p-6 text-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-download h-8 w-8 text-secondary mx-auto mb-2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" x2="12" y1="15" y2="3"></line></svg><p class="text-3xl font-bold mb-1">2.5k+</p><p class="text-sm text-muted-foreground">Total Downloads</p></div>
          </div>
