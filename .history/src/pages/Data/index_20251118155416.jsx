        ...
        <div className="max-w-7xl mx-auto px-6 text-white">
            ...
            {[
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-5">
                  ...
                  {/* LEFT */}
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-database h-5 w-5 text-secondary mt-1"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M3 5V19A9 3 0 0 0 21 19V5"></path><path d="M3 12A9 3 0 0 0 21 12"></path></svg>
          ...
          <div className="p-8 mt-12 bg-white/5 border border-white/10 backdrop-blur rounded-2xl">
            ...
            <div className="flex gap-4 mt-6">
              ...
              <button className="px-5 py-2 rounded-xl border border-[#00d9ff] text-[#00d9ff] hover:bg-emerald-400/10 transition">
                Get API Key
              </button>
