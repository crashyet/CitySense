  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-40
        bg-gradient-to-b from-[#114055]/30 via-transparent to-transparent pointer-events-none">
      </div>

      <div className="mx-auto max-w-7xl px-6 relative">

        {/* Title & Subtitle */}
        <h2 className="text-3xl font-semibold">Smart City Dashboard Lorem, ipsum dolor sit amet consectetur adipisicing elit. Consectetur expedita cupiditate iusto velit nisi recusandae a omnis, dolore architecto, vel consequatur, et totam enim dignissimos illo nihil quo eos minima?
        </h2>
