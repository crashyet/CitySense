...
export default function Dashboardpack() {
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl transition hover:border-emerald-300/40">
              <div
                className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-gradient-to-br 
              ...
              <div class="p-6 pt-0">
                ...
                >
                  <div
                    ...
                    style="position: relative; cursor: default; width: 100%; height: 100%; max-height: 300px; max-width: 837px;"
                  >
                    <svg
                      cx="50%"
                      cy="50%"
                    ...
                    >
                      ...
                      <defs>
                        <clipPath id="recharts1-clip">
                          <rect x="5" y="5" height="290" width="827"></rect>
                        </clipPath>
                      </defs>
  ...
  L 418.5,150 Z"
                          ...
                          >
                            <path
                              ...
                              tabindex="-1"
                              class="recharts-sector"
                              d="M 359.7214747707527,69.09830056250526
    A 100,100,0,
    0,0,
  ...
  L 418.5,150 Z"
                          ...
                          >
                            <path
                              ...
                              tabindex="-1"
                              class="recharts-sector"
                              d="M 337.59830056250524,208.7785252292473
    A 100,100,0,
    0,0,
  ...
  L 418.5,150 Z"
                          ...
                          >
                            <path
                              ...
                              tabindex="-1"
                              class="recharts-sector"
                              d="M 449.4016994374947,245.10565162951536
    A 100,100,0,
    0,0,
  ...
  L 418.5,150 Z"
                          ...
                          >
                            <path
                              ...
                              tabindex="-1"
                              class="recharts-sector"
                              d="M 513.6056516295154,180.90169943749476
    A 100,100,0,
    0,0,
  ...
  L 418.5,150 Z"
                        ...
                        <g class="recharts-layer recharts-pie-labels">
                          <g class="recharts-layer">
                            <text
                              ...
                              fill="hsl(var(--secondary))"
                            >
                              <tspan x="472.9788599687456" dy="0em">
                                Solar 35%
                              </tspan>
                            </text>
                          </g>
                          <g class="recharts-layer">
                            <text
                              ...
                              fill="hsl(var(--accent))"
                            >
                              <tspan x="299.9773991285835" dy="0em">
                                Wind 25%
                              </tspan>
                            </text>
                          </g>
                          <g class="recharts-layer">
                            <text
                              ...
                              name="Hydro"
                              alignment-baseline="middle"
                              x="381.41796067500627"
                              y="264.12678195541844"
                              class="recharts-text recharts-pie-label-text"
                              text-anchor="end"
                              fill="hsl(158 80% 60%)"
                            >
                              <tspan x="381.41796067500627" dy="0em">
                                Hydro 20%
                              </tspan>
                            </text>
                          </g>
                          <g class="recharts-layer">
                            <text
                              ...
                              fill="hsl(189 80% 60%)"
                            >
                              <tspan x="503.3528137423857" dy="0em">
                                Natural Gas 15%
                              </tspan>
                            </text>
                          </g>
                          <g class="recharts-layer">
                            <text
                              ...
                              alignment-baseline="middle"
                              x="537.0226008714166"
                              y="168.77213580482774"
                              class="recharts-text recharts-pie-label-text"
                              text-anchor="start"
                              fill="hsl(var(--muted))"
                            >
                              <tspan x="537.0226008714166" dy="0em">
                                Other 5%
                              </tspan>
                            </text>
                          </g>
                    ...
                    <div
                      ...
                      style="visibility: hidden; pointer-events: none; position: absolute; top: 0px; left: 0px; transform: translate(463.855px, 195.355px);"
                    >
                      <div
