...
import WeeklyAQIChart from "../../components/WeeklyAQIChart";
    ...
    <>
      ...
      <div className="relative w-full bg-gradient-to-b from-black via-[#071014] to-[#0d1a24] text-white pb-24 pt-32">
        <div className="mx-auto max-w-7xl px-6">
          ...
          {/* Header */}
          <div className="mb-10">
            <h1 className="text-3xl md:text-4xl font-semibold">Dasbor Kota Cerdas</h1>
            <p className="text-emerald-100/80 mt-2">
              Wawasan real-time untuk mobilitas, energi, sampah, dan lingkungan.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl transition hover:border-emerald-300/40">
              ...
              <div className="relative">
                <p className="text-xs uppercase tracking-widest text-emerald-200/80">Kualitas Udara</p>
                <p className="mt-1 text-xl font-semibold">AQI 45 • Baik</p>
                <p className="text-xs text-emerald-200/70 mt-1">+3% hari ini</p>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl transition hover:border-emerald-300/40">
              ...
              <div className="relative">
                <p className="text-xs uppercase tracking-widest text-emerald-200/80">Energi Terbarukan</p>
                <p className="mt-1 text-xl font-semibold">80% pasokan listrik</p>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl transition hover:border-emerald-300/40">
              ...
              <div className="relative">
                <p className="text-xs uppercase tracking-widest text-emerald-200/80">Pengelolaan Sampah</p>
                <p className="mt-1 text-xl font-semibold">68% didaur ulang</p>
                <p className="text-xs text-emerald-200/70 mt-1">-6% ke TPA</p>
                <div className="mt-4 h-1 w-full bg-white/10 rounded-full overflow-hidden">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl transition hover:border-emerald-300/40">
              ...
              <div className="relative">
                <p className="text-xs uppercase tracking-widest text-emerald-200/80">Transportasi Cerdas</p>
                <p className="mt-1 text-xl font-semibold">Penggunaan EV 41%</p>
                <p className="text-xs text-emerald-200/70 mt-1">-18% kemacetan</p>
                <div className="mt-4 h-1 w-full bg-white/10 rounded-full overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl md:col-span-1">
              <h3 className="text-lg font-semibold mb-4">Distribusi Campuran Energi</h3>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
              <h3 className="text-lg font-semibold mb-4">Kemacetan Lalu Lintas</h3>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl md:col-span-2">
              <h3 className="text-lg font-semibold mb-4">Tren AQI Mingguan</h3>
