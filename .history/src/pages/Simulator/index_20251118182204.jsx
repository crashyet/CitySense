              ...
              {savedScenarios.map((s) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 mt-3 text-sm text-gray-300 gap-y-1">
                    <p>EV: <span className="font-semibold text-white">
  {s.values?.electricVehicle ?? 0}%
</span></p>

<p>Taman Hijau: <span className="font-semibold text-white">
  {s.values?.greenSpaces ?? 0}
</span></p>

<p>Pengelolaan Limbah: <span className="font-semibold text-white">
  {s.values?.wasteSystem ?? 0}%
</span></p>

<p>Panel Surya: <span className="font-semibold text-white">
  {s.values?.solarPanel ?? 0}%
</span></p>
