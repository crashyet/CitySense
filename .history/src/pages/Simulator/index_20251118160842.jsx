    ...
    <>
      ...
      <div className="min-h-screen w-full bg-gradient-to-b from-[#0a0f0d] via-[#0c1416] to-[#0a0e13] text-white pt-28 pb-32">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8"><div class="rounded-lg border bg-card text-card-foreground shadow-sm glass hover-scale"><div class="p-6"><div class="flex items-center gap-4 mb-4"><div class="p-3 rounded-lg bg-secondary/20"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-leaf h-6 w-6 text-secondary"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"></path><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"></path></svg></div><div><p class="text-sm text-muted-foreground">Pengurangan Karbon</p><p class="text-3xl font-bold">131</p><p class="text-sm text-secondary">kg CO₂/tahun</p></div></div></div></div><div class="rounded-lg border bg-card text-card-foreground shadow-sm glass hover-scale"><div class="p-6"><div class="flex items-center gap-4 mb-4"><div class="p-3 rounded-lg bg-accent/20"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-zap h-6 w-6 text-accent"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path></svg></div><div><p class="text-sm text-muted-foreground">Penghematan Energi</p><p class="text-3xl font-bold">540</p><p class="text-sm text-accent">kWh/tahun</p></div></div></div></div><div class="rounded-lg border bg-card text-card-foreground shadow-sm glass hover-scale"><div class="p-6"><div class="flex items-center gap-4 mb-4"><div class="p-3 rounded-lg bg-secondary/20"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trending-up h-6 w-6 text-secondary"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"></polyline><polyline points="16 7 22 7 22 13"></polyline></svg></div><div><p class="text-sm text-muted-foreground">Skor Kelayakan Huni</p><p class="text-3xl font-bold">45</p><p class="text-sm text-secondary">/100</p></div></div></div></div></div>
