      ...
      <div className="min-h-screen w-full bg-gradient-to-b from-[#0a0f0d] via-[#0c1416] to-[#0a0e13] text-white pt-28 pb-32">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-emerald-200/70 mt-2 text-sm md:text-base">
            Sesuaikan parameter urban dan visualisasikan dampaknya terhadap masa
            depan kota.
          </p>
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10">
              ...
              <h3 className="text-3xl font-semibold mt-2 text-emerald-300">
                129
              </h3>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div class="rounded-lg border bg-card text-card-foreground shadow-sm glass hover-scale">
              <div class="p-6">
                <div class="flex items-center gap-4 mb-4">
                  <div class="p-3 rounded-lg bg-secondary/20">
                    <svg
                      ...
                      class="lucide lucide-leaf h-6 w-6 text-secondary"
                    >
                  ...
                  <div>
                    ...
                    <p class="text-3xl font-bold">131</p>
                    <p class="text-sm text-secondary">kg CO₂/tahun</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="flex items-center gap-4 mb-4">
                  <div class="p-3 rounded-lg bg-accent/20">
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      class="lucide lucide-zap h-6 w-6 text-accent"
                    >
                  ...
                  <div>
                    ...
                    <p class="text-sm text-accent">kWh/tahun</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="flex items-center gap-4 mb-4">
                  <div class="p-3 rounded-lg bg-secondary/20">
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      class="lucide lucide-trending-up h-6 w-6 text-secondary"
                    >
                  ...
                  <div>
                    ...
                    <p class="text-sm text-secondary">/100</p>
                  </div>
                </div>
              </div>
            </div>
