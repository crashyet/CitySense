        ...
        <div className="mb-8 flex items-end justify-between">
          <div>
            <h2 className="text-2xl font-semibold md:text-3xl">
              Smart City Dashboard  Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum ab, explicabo provident aspernatur velit iste excepturi, aut delectus odio sed adipisci nulla iure atque sequi earum. Praesentium aperiam aspernatur atque!
            </h2>
