        ...
        <div className="mb-8 flex items-end justify-between">
          <div>
            <h2 className="text-2xl font-semibold md:text-3xl">
              Smart City Dashboard   Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam rem cupiditate nemo qui? Molestiae, alias. Recusandae atque culpa sed dolores asperiores, at veniam ratione, beatae, laborum ipsam hic nobis. Earum.
            </h2>
