        ...
        <div className="mb-8 flex items-end justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-emerald-100/80">
              ...
              circularity, and smart mobility.  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam, dolor labore corporis sunt earum, cumque maiores quasi eum perferendis odio dolores architecto adipisci minima ea tempore non! Molestias, commodi quod.
            </p>
          </div>
